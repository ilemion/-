...
**变更后项目周期: 2026年3月16日-5月10日 (共56天/8周)**

---

## ⚠️ 变更摘要

| 变更单号 | 变更内容 | 工期影响 | 成本影响 | 里程碑调整 |
|---------|---------|---------|---------|-----------|
| CR-2026-001 | Q1报告频率调整为半月报 | +5天 | +¥15,000 | M2: 3月31日→4月5日 |
| CR-2026-002 | 移动端审核适配 | +14天 | +¥180,000 | M2: 4月5日→4月19日<br>M3: 4月10日→4月24日<br>M4: 4月26日→5月10日 |
...
```mermaid
gantt
    title 云南省企业就业失业数据采集系统 - 项目Gantt图(含变更)
    ...
    M2: 核心功能完成   :milestone, m2, after cr1_5, 0d
...
<head>
    ...
    <title>云南省企业就业失业数据采集系统 - Gantt图(含变更)</title>
...
<body>
    <div class="container">
        ...
        <p class="subtitle">项目进度Gantt图(含变更) | 项目周期: 8周 | 2026年3月16日-5月10日</p>
        ...
        <div class="change-info">
            <h3>⚠️ 变更影响摘要</h3>
            <p><strong>CR-2026-001 (报告频率调整):</strong> 1-3月改为半月报, +5天, +¥15,000, M2延至4月5日</p>
            <p><strong>CR-2026-002 (移动端适配):</strong> 新增iOS/Android审核, +14天, +¥180,000, M4延至5月10日</p>
            <p><strong>总影响:</strong> +19天, +¥195,000, 项目周期从6周延长至8周</p>
        </div>
...
| 项目 | 原始计划 | 变更后计划 | 差异 |
|------|---------|-----------|------|
| 项目周期 | 6周 (42天) | 8周 (56天) | +14天 |
| 开始日期 | 2026-03-16 | 2026-03-16 | 不变 |
| 结束日期 | 2026-04-26 | 2026-05-10 | +14天 |
| 总任务数 | 45个 | 58个 | +13个 |
| 里程碑 | 4个 | 4个 | 不变 |

### 里程碑调整对比

| 里程碑 | 原始日期 | 变更1后 | 变更2后 | 总延期 |
|--------|---------|---------|---------|--------|
| M1: 需求基准化 | 3月20日 | 3月20日 | 3月20日 | 0天 |
| M2: 核心功能完成 | 3月31日 | 4月5日 | 4月19日 | +19天 |
| M3: 数据分析上线 | 4月10日 | - | 4月24日 | +14天 |
| M4: 系统试运行 | 4月26日 | - | 5月10日 | +14天 |
